...
// Import the GlassSurface component
...
const Navbar = ({
  ...
  return (
    <nav className="fixed w-full z-[100] top-0 left-0">
      ...
      {/* --- NEW GLASS SURFACE BACKGROUND --- */}
      <div className="absolute inset-0 w-full h-20 z-0">
        <GlassSurface
          width="100%"
          height={80} // Matches the h-20 of the navbar
          borderRadius={0} 
          borderWidth={0}
          blur={15}
          opacity={0.8}
          backgroundOpacity={0.2}
          className="w-full h-full border-b border-white/20"
        />
      </div>
