...
export default function TiltedCard({
  ...
  rounded = 'rounded-[15px]' // <--- NEW PROP: Default rounded corners
}) {
  ...
  return (
    ...
    >
      ...
      >
        <motion.img
          src={imageSrc}
          // UPDATED: Now uses the `rounded` prop
      ...
      {showTooltip && (
        <motion.figcaption
          className="pointer-events-none absolute left-0 top-0 rounded-[4px] bg-white/0 px-[10px] py-[4px] text-[10px] text-[#2d2d2d] opacity-0 z-[3] hidden sm:block"
          style={{
            x,
            y,
            opacity,
