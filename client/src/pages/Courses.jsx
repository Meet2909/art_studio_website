    ...
    return (
        ...
        <div className="max-w-[95%] mx-auto">
            ...
            {/* FIX 2: Responsive Text Size (4xl on mobile, 7xl on desktop) */}
            <h2 className="text-5xl md:text-7xl font-bold text-[#000000] mb-4 drop-shadow-sm" 
            ...
            <div className="flex flex-wrap justify-center gap-3 md:gap-4 mt-8">
                ...
                <button
                    key={f}
                    onClick={() => setFilter(f)}
                    className={`px-6 py-2 md:px-8 md:py-3 text-sm md:text-xl rounded-full border transition-all duration-300 font-bold ${
                    filter === f
